...
urlpatterns = [
    ...
    path("photos/<int:image_id>/update/",
         views.update_cat_image, name="update_cat_image"),
    path("photos/<int:image_id>/delete/",
         views.delete_cat_image, name="delete_cat_image"),
    path("<int:cat_id>/photos/reorder/",
         views.reorder_cat_images, name="reorder_cat_images"),
    path("photos/<int:image_id>/set-primary/",
         views.set_primary_image, name="set_primary_image"),
    path("search/", views.search_cats, name="search_cats"),
    path("get-by-ids/", views.get_cats_by_ids, name="get_cats_by_ids"),
]
